      ...
      <div class="panel-body">
        ...
        <form class="form-horizontal" name="contact_form" id="contact_form" enctype="multipart/form-data" method="post" action="process_form.php">
          ...
          <fieldset>
			...
			<div class="form-group">
              <label class="col-lg-4 control-label" for="region"><span class="required">*</span>Region:</label>
			  <br>
				<div class="col-lg-5">			
					<select name="region" id="region"><span id="region_err" class="error"></span>
			...
			<div class="form-group">
              <label class="col-lg-4 control-label" for="birthday">Birthday:</label>
              <div class="col-lg-5">
            ...
            <div class="form-group">
              <label class="col-lg-4 control-label" for="contact_no1"><span class="required">*</span>Contact Number:</label>
              <div class="col-lg-5">
            ...
            <div class="form-group">
              <label class="col-lg-4 control-label" for="contact_no2">Alternate Contact Number:</label>
              <div class="col-lg-5">
			...
			<div class="form-group">
              ...
              <div class="col-lg-5">
                <input type="text" value="<?php echo $results[0]["password"] ?>" placeholder="Password" id="password" class="form-control" name="password"><span id="password_err" class="error"></span>
              </div>
            </div>				
            ...
            <div class="form-group">
              <div class="col-lg-5 col-lg-offset-4">
				...
				<a href="index_admin.php">Cancel</a> 
              </div>
            </div>
          </fieldset>
        </form>
...
function validateForm() {
	...
	if (region == "" ) {
		$("#region_err").html("Select regional office.");
		$('#region_err').fadeIn("fast"); 
		errCnt++;
