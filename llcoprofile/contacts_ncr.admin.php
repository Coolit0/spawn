...
<div class="row">
  <ul class="breadcrumb">
      <li><a href="index_ncr.admin.php">Home</a></li>
  ...
  <div class="row">
    <div class="panel panel-primary">
      ...
      <div class="panel-body">
        ...
        <form class="form-horizontal" name="contact_form" id="contact_form" enctype="multipart/form-data" method="post" action="process_form.ncr.admin.php">
          ...
          <fieldset>
			...
			<div class="form-group">
              ...
              <div class="col-lg-5">
			  <textarea id="profession" name="profession" rows="3" class="form-control" placeholder="Profession"><?php echo $results[0]["profession"] ?></textarea>
              </div>
            </div>	
            ...
            <div class="form-group">
              ...
              <div class="col-lg-5">
                <input type="text" value="<?php echo $results[0]["email_address"] ?>" placeholder="Email Address" id="email_id" class="form-control" name="email_id"><span id="email_id_err" class="error"></span>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="col-lg-5 col-lg-offset-4">
				...
				<a href="index_ncr.admin.php">Cancel</a> 
              </div>
            </div>
          </fieldset>
        </form>
